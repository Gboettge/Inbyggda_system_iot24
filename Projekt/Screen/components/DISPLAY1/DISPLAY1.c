...
void display_ui(display_s *display, char* leftTop, char* leftMid, char* leftButtom, char* score, char* time)
{
    lv_obj_t *scr = lv_disp_get_scr_act(display->disp);
    
    lv_obj_t *leftTop = lv_label_create(scr); 
    lv_obj_t *leftCenter = lv_label_create(scr);
    lv_obj_t *leftBottom = lv_label_create(scr);
    lv_obj_t *rightTop = lv_label_create(scr);
